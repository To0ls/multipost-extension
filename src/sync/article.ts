...
export const ArticleInfoMap: Record<string, PlatformInfo> = {
  ...
  // experimental: based on aibeike 1.6.5 Gelonghui ARTICLE DOM path
  ARTICLE_GELONGHUI: {
    type: "ARTICLE",
  ...
  // experimental: based on aibeike 1.6.5 Jiankangjie ARTICLE DOM path
  ARTICLE_JIANKANGJIE: {
    type: "ARTICLE",
  ...
  // experimental: based on aibeike 1.6.5 Kaidiwang ARTICLE DOM path
  ARTICLE_KAIDIWANG: {
    type: "ARTICLE",
  ...
  // experimental: based on aibeike 1.6.5 Dayuhao ARTICLE DOM path
  ARTICLE_DAYUHAO: {
    type: "ARTICLE",
