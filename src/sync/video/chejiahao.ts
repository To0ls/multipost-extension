  ...
  try {
    ...
    const ChejiahaoVideoUploaderInline = class ChejiahaoVideoUploader {
      ...
      public async publishIfAutoEnabled(autoPublish: boolean, videoUploaded: boolean): Promise<void> {
        ...
        const aibeikeVideoPublishButton = Array.from(document.querySelectorAll<HTMLButtonElement>("button")).find(
          (button) => {
        ...
        const publishButton = aibeikeVideoPublishButton || exactPublishButton || null;
